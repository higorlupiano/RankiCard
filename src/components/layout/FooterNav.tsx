...
export const FooterNav: React.FC<FooterNavProps> = ({ activeTab, onTabChange, isAdmin = false }) => {
    return (
        <div className="absolute bottom-1 md:bottom-2 left-0 right-0 z-30 mx-2 rounded-lg bg-[#1a0a00]/90 backdrop-blur-sm overflow-visible" style={{ borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--theme-accent)' }}>
